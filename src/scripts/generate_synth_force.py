...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--Lx_mm", type=float, default=30.0, help="Width in mm.")
    p.add_argument("--Ly_mm", type=float, default=20.0, help="Height in mm.")
    p.add_argument("--Nx", type=int, default=60, help="Grid points in x.")
    p.add_argument("--Ny", type=int, default=40, help="Grid points in y.")
